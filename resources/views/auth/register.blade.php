        ...
        <div class="row justify-content-center">
            <div class="w-50">
                <div class="card border-0">
                    <div class="card-header border-0 bg-light" style="font-size: 1.5rem; font-weight: bold;">
                        {{ __('Register') }}</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="email-verify" type="email"
                                    class="form-control @error('email-verify') is-invalid @enderror" name="email-verify"
                                    value="{{ old('email-verify') }}" required autocomplete="email-verify">
                                @error('email-verify')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="mb-3">
                                ...
                                <input id="plate-number" type="text"
                                    class="form-control @error('plate-number') is-invalid @enderror" name="plate-number"
                                    required autocomplete="new-plate-number">
                                @error('plate-number')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
